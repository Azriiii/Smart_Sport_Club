...
Utilisateurs::Utilisateurs(int cin,QString nom,QString email,QString motdepasse,QString adresse,QString role)
{
    this->Cin=cin;
    this->Nom=nom;
    this->Email=email;
...
QString Utilisateurs::get_Email(){return Email;}
...
query.prepare("INSERT INTO UTILISATEUR (CIN, NOM, EMAIL, MOTDEPASSE, ADRESSE, ROLE) "
                    "VALUES (:Cin, :Nom, :Email, :Motdepasse, :Adresse, :Role)");
